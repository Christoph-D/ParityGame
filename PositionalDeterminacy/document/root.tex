...
\isa{{\isacharprime}a} is the vertex type).  However, it turned out
...
not requiring that the set of vertices is \isa{UNIV\ ::\
  {\isacharprime}a\ set} but rather a subset of \isa{UNIV\ ::\
  {\isacharprime}a\ set}, it becomes easier to reason about subgraphs.
